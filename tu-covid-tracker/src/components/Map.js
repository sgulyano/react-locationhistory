...
// function insert_roi(map, place) {
//     var loc = L.circle([parseFloat(place.lat), parseFloat(place.lon)], {
//         color: 'red',
//         fillColor: '#f03',
//         fillOpacity: 0.5,
//         radius: 500
//     }).addTo(map);
//     loc.bindPopup(place.name);
// }


function LocationMap({ heatdata }) {
    var mymap

    const [heatmapLayer, setheatmapLayer] = useState(null);

    useEffect(() => {
        mymap = window.create_map('pk.eyJ1IjoieW9zYXJ1biIsImEiOiJjazhmeGkzZWgwN3V6M3BvM3J3OTBzM2JmIn0.bIOwcK1dDMh0xuJaLebYcw')
        setheatmapLayer(window.heatmap(mymap))
        ...
        // var mymap = L.map('mymap').setView([14.069737, 100.603635], 13);
        ...
        //     tileSize: 512,
        //     zoomOffset: -1,
        //     accessToken: 'pk.eyJ1IjoieW9zYXJ1biIsImEiOiJjazhmeGkzZWgwN3V6M3BvM3J3OTBzM2JmIn0.bIOwcK1dDMh0xuJaLebYcw'
        // }).addTo(mymap);
            ...
            .then(res => {
                for (var key in res) {
                    if (res.hasOwnProperty(key)) {
                        window.insert_roi(mymap, res[key])
                    }
                }
            })
    }, []);
    ...
    return (
        <div id='mymap'></div>
        // <Map center={[14.069737, 100.603635]} zoom={13}>
        //     <TileLayer
        ...
        //         accessToken='pk.eyJ1IjoieW9zYXJ1biIsImEiOiJjazhmeGkzZWgwN3V6M3BvM3J3OTBzM2JmIn0.bIOwcK1dDMh0xuJaLebYcw'
        //     />
        //     <Marker position={[14.069737, 100.603635]}>
...
export default connect(mapStateToProps, null)(LocationMap)